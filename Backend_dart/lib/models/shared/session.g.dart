...
class _$Session extends Session {
  ...
  _$Session._({this.token, this.login, this.creationDate, this.isValid})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(token, 'Session', 'token');
    BuiltValueNullFieldError.checkNotNull(login, 'Session', 'login');
    BuiltValueNullFieldError.checkNotNull(
        creationDate, 'Session', 'creationDate');
    BuiltValueNullFieldError.checkNotNull(isValid, 'Session', 'isValid');
  }
