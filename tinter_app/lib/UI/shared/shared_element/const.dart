...
class TinterTheme extends ChangeNotifier {
  ...
  void changeTheme() {
    theme = (theme == MyTheme.dark) ? MyTheme.light : MyTheme.dark;
    notifyListeners();
  }
}
...
class TinterColors {
  ...
  Color get primary => theme.theme == MyTheme.dark
      ? TinterDarkThemeColors.primary
      : TinterLightThemeColors.primary;
  ...
  Color get button => theme.theme == MyTheme.dark
      ? TinterDarkThemeColors.button
      : TinterLightThemeColors.button;
