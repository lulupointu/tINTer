    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'organisationEvenements':
          ...
          break;
        case 'goutsMusicaux':
          result.goutsMusicaux = serializers.deserialize(value,
                  specifiedType:
...
class _$BuildUserAssociatif extends BuildUserAssociatif {
  ...
  @override
  final List<String> goutsMusicaux;
  @override
  final String login;
  @override
  final String name;
...
class BuildUserAssociatifBuilder
  ...
  List<String> get goutsMusicaux => _$this._goutsMusicaux;
  set goutsMusicaux(List<String> goutsMusicaux) =>
  ...
  BuildUserAssociatifBuilder get _$this {
    if (_$v != null) {
      ...
      _goutsMusicaux = _$v.goutsMusicaux;
      _login = _$v.login;
      _name = _$v.name;
