...
class _$BuildBinomePair extends BuildBinomePair {
  ...
  _$BuildBinomePair._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        binomePairId, 'BuildBinomePair', 'binomePairId');
      ...
      _$result = _$v ??
          new _$BuildBinomePair._(
              ...
              otherSurname: BuiltValueNullFieldError.checkNotNull(
                  otherSurname, 'BuildBinomePair', 'otherSurname'),
              otherEmail:
                  BuiltValueNullFieldError.checkNotNull(otherEmail, 'BuildBinomePair', 'otherEmail'),
              associations: associations.build(),
              lieuDeVie: lieuDeVie,
              groupeOuSeul: BuiltValueNullFieldError.checkNotNull(groupeOuSeul, 'BuildBinomePair', 'groupeOuSeul'),
