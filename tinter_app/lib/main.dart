...
class TinterHome extends StatefulWidget {
  final List<TinterTab> tabsAssociatif = [MatchsTab(), DiscoverAssociatifTab2(), UserTab3()];
  final List<TinterTab> tabsScolaire = [BinomesTab(), DiscoverScolaireTab(), UserTab3()];
