                      ...
                      if ((matchedBinomePairMatchesState
                        ...
                        WidgetsBinding.instance
                          ...
                          Future.delayed(Duration(milliseconds: 500), () {
                            overlay.insert(introduceBinomeOfBinomeOverlayEntry);
                          });
                        });
                      }
    ...
    return GestureDetector(
      onTapUp: (details) {
        if (details.globalPosition.dx <
                buttonOffset.dx + buttonSize.width + 20 &&
            details.globalPosition.dx > buttonOffset.dx - 20 &&
            details.globalPosition.dy > buttonOffset.dy + 20 &&
            details.globalPosition.dy <
                buttonOffset.dy + buttonSize.height - 20) {
          removeSelf();
        }
      },
      child: Material(
