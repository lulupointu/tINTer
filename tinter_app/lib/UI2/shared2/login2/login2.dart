    ...
    MaterialApp(
      home: KeyboardVisibilityProvider(
        child: KeyboardDismissOnTap(
          child: TinterAuthenticationTab2(),
        ),
      ),
    ),
  );
...
class TinterAuthenticationTab2 extends StatefulWidget {
  ...
  @override
  _TinterAuthenticationTab2State createState() =>
      _TinterAuthenticationTab2State();
}

class _TinterAuthenticationTab2State extends State<TinterAuthenticationTab2> {
              ...
              Align(
                ...
                child: Container(
                  height: constraints.maxHeight *
                      (1 - TinterAuthenticationTab2.fractions['top']),
      ...
      children: [
        Flexible(
          ...
          child: SingleChildScrollView(
            padding:
                EdgeInsets.only(left: 30.0, right: 30.0, top: 40, bottom: 20.0),
                      ...
                      return Consumer<TinterTheme>(
                        builder: (context, tinterTheme, child) {
                          return AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  tinterTheme.colors.secondary.withAlpha(150),
                              borderRadius:
                            ...
                            margin: EdgeInsets.only(
                                bottom: hasError && displayError ? 20 : 0),
                      ...
                      Consumer<TinterTheme>(
                        ...
                        child: TextField(
                          ...
                          decoration: const InputDecoration(
                            ...
                            contentPadding:
                                EdgeInsets.only(bottom: 14, left: 10.0),
                      ...
                      Consumer<TinterTheme>(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            disabledBorder: InputBorder.none,
                            contentPadding:
                                EdgeInsets.only(bottom: 8, left: 10.0),
                            floatingLabelBehavior: FloatingLabelBehavior.never,
                          ),
                        ),
                      ),
                          ...
                          builder: (BuildContext context,
                            ...
                            return LayoutBuilder(
                              builder: (BuildContext context,
                                ...
                                return FlatButton(
                                  onPressed:
                                      isLoading ? null : _onAuthenticationTry,
                                  ...
                                  child: Consumer<TinterTheme>(
                                    ...
                                    return AnimatedContainer(
                                      ...
                                      height: 40,
                                      width:
                                          isLoading ? 40 : constraints.maxWidth,
